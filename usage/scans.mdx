...
To create scans, users should navigate to the [Scan Creation](https://docs.shieldcyber.io/docs/usage/scans/scan-creation.html) to configure and create the scans.

### Schedule

Users can tie created scans to schedules so that the scans run on a one time, daily, weekly, or monthly basis.  To schedule a scan to run, navigate to the [Schedule](https://platform.shieldcyber.io/scan/scheduling/schedule) and click **Add Schedule**. 

<Frame type="glass">
  <img src="/images/scan-schedule.png" />
</Frame>
