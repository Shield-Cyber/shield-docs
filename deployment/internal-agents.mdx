...
Users can navigate directly to the [**Deploy Agents**](https://platform.shieldcyber.io/v2/dashboard?hub=deploy-agents) page to access a script that can be deployed on a host-by-host basis or deployed to multiple hosts via a preferred remote monitoring and management tool.
